...
int main(void) {
  ...
  for(int i = 0; i < y; i++) {
	...
	b2Vec2 checkPointlocation((j+0.5)*10.0*PIXTOMETERS, (HEIGHT - (i+0.5)*10.0)*PIXTOMETERS);
...
/* 	  
  ...
  */
  ...
  Car car1(world, b2Vec2((videomode.width/17)* PIXTOMETERS, videomode.height/2 * PIXTOMETERS), sf::Color::Red);
  Car car2(world, b2Vec2((videomode.width/17)* PIXTOMETERS, videomode.height/3 * PIXTOMETERS), sf::Color::Blue);
